          ...
          <div class="over_page" v-show="middle_show_over_page">
            ...
            <div class="uncategorized cart" ref="uncategorized">
              ...
              <div class="box_container">
                ...
                <div
                  class="box"
                  v-for="(proj_name, index) in ended_projects"
                  :key="index"
                >
                  {{ proj_name }}
                </div>
            ...
            <div v-for="(endParts, index1) in ended_projects" :key="index1">
              <div class="cart">
                ...
                <div class="box_container">
                  <div
                    class="box"
                    v-for="(proj_name, index2) in ended_projects[index1]
                      .project_box"
                    :key="index2"
                  >
                    {{ proj_name }}
            ...
            <div class="trash_page_middle">
              ...
              >
                ...
                <div class="forever_delete_confirm_btn_container">
                  ...
                  <button
                    class="forever_delete_confirm_btn forever_delete_confirm_btn_delete"
                    @click="forever_delete_project_delete"
                  >
                    刪除
                  </button>
                </div>
  ...
  methods: {
    ...
    change(index) {
      ...
      if (index === 3) {
        ...
        axios.post(this.getPath, info).then((res) => {
          console.log(
            res.data.item.in_month.map((project) => project.project_name)
          );
    ...
    //刪除後的專案跑到垃圾桶
    delete_project_click() {
      //可以刪除總覽的project 但沒辦法拿到專案名稱
      // 請求獲取專案資料
